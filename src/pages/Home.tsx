...
<section className="flex flex-col items-center justify-center min-h-[90vh] bg-gray-700 bg-[url('imgs/background.jpg')] bg-cover bg-center bg-blend-overlay px-4 sm:px-6 text-center">
  <div className="max-w-3xl w-full">
    ...
    <motion.h1
      ...
      className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white leading-tight drop-shadow-lg"
    >
      Welcome to Tasty Bites
    </motion.h1>

    {/* Subtext — responsive & adaptive */}
    <motion.p
      initial={{ opacity: 1 }}
      animate={{ opacity: 1 }}
      transition={{ delay: 0.5 }}
      className="mt-4 text-sm sm:text-base md:text-lg lg:text-xl max-w-2xl mx-auto font-medium text-white leading-relaxed"
    >
      {/* Large screens: typing animation */}
      <span
        className="
          hidden lg:inline-block
          animate-typing border-orange-400 pr-2 whitespace-nowrap overflow-hidden
          [--typing-speed:5s]
        "
      >
      ...
      {/* Small & medium screens: static text */}
    ...
    <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
      <motion.a
        ...
        className="w-full sm:w-auto rounded-full bg-gradient-to-r from-orange-500 to-rose-500 px-8 py-3 font-semibold text-white shadow-xl"
      >
        View Menu
      </motion.a>
      ...
      <motion.a
        ...
        className="w-full sm:w-auto rounded-full bg-white/90 px-8 py-3 font-semibold text-gray-900 shadow"
      >
        Book a Table
      </motion.a>
    </div>
